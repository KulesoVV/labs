...
int main()
{
	...
	while (i != 1) {
		...
		cout << "4. Постфиксная операция ++" << endl;
		cin >> a;
		switch (a) {
		case 0:
			i = 1;
		...
		case 4:
			cout << "Первый продукт до изменения:" << endl;
			obj1.print();
			cout << "Первый продукт после постфиксной операции ++:" << endl;
			obj1++.print();
			cout << "Первый продукт после всех изменений:" << endl;
			obj1.print();
			break;
